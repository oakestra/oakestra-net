...
// Additionally, the NetManager expects a 'New(base ModuleBase) ModuleInterface' function to be implemented.
// This function receives a copy of its ModuleBase and returns a freshly initialised instance of the ebpf module.

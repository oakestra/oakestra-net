...
func TestTableInsertSuccessfull(t *testing.T) {
	...
	entry := TableEntry{
		...
		ServiceIP: []ServiceIP{{
			...
			Address_v6: net.ParseIP("fdff:1000::1"),
		}},
	}
...
func TestTableDeleteMany(t *testing.T) {
	...
	entry2 := TableEntry{
		...
		Instancenumber:   0,
		Cluster:          0,
		Nodeip:           net.ParseIP("10.30.0.2"),
		Nodeport:         1003,
		Nsip:             net.ParseIP("10.18.64.1"),
		Nsipv6:           net.ParseIP("fc00::101"),
		ServiceIP: []ServiceIP{{
			IpType:     RoundRobin,
			Address:    net.ParseIP("10.30.1.2"),
			Address_v6: net.ParseIP("fdff:1000::2"),
		}},
	}
	...
	err := table.RemoveByNsip(net.ParseIP("10.18.64.1"))
	if err != nil {
		t.Error("Error during deletion")
	}
...
func TestTableDeleteMany_v6(t *testing.T) {
	...
	err := table.RemoveByNsip(net.ParseIP("fc00::101"))
	if err != nil {
		t.Error("Error during deletion")
	}
...
func TestTableDeleteManyInstances_1(t *testing.T) {
	...
	entry3 := TableEntry{
		...
		ServiceIP: []ServiceIP{{
			...
			Address_v6: net.ParseIP("fdff:1000::3"),
		}},
	}
